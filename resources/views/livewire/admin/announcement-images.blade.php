<div>
  ...
  <div class="mb-8">
    <label class="block font-semibold mb-2">
      カバー画像<span class="font-normal text-xs">（正方形・横長両方に対応できる画像）</span>
    </label>
  ...
  <div>
    ...
    @error('gallery') <p class="text-sm text-red-600 mb-2">{{ $message }}</p> @enderror
    @error('newGallery.*') <p class="text-sm text-red-600 mb-2">{{ $message }}</p> @enderror
