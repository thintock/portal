<div>
  ...
  ========================== --}}
  <div class="mb-8">
    <label class="block font-semibold mb-2">カバー画像<span class="font-normal text-xs">（正方形・横長両方に対応できる画像）</span></label>
  ...
  <div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 mb-3">
      ...
      {{-- 追加ボタン --}}
      <label
        class="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 w-full h-28 text-gray-400 hover:bg-gray-50 cursor-pointer transition">
